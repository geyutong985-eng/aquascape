      ...
      <main className="mx-auto max-w-7xl px-4 pb-20 pt-24 md:px-8">
        <section className="border-b border-border pb-6">
          <div>
            ...
            <h1 className="mt-4 text-3xl font-heading font-medium leading-[1.16] tracking-[0.02em] text-foreground md:text-5xl">
              让你的鱼缸造景走得更远
            </h1>
        ...
        <section className="membership-billing py-8">
          ...
          <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-baseline lg:gap-4">
              <h2 className="text-xl font-heading font-medium text-foreground md:text-2xl">选择会员方案</h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-6">
                    ...
                    <h3 className="mt-2 text-2xl font-heading font-medium text-foreground">{plan.cnName}</h3>
        ...
        <section className="border-t border-border py-14">
          <div className="mb-7 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <h2 className="text-3xl font-heading font-medium text-foreground">功能对比</h2>
        ...
        <section className="grid gap-5 border-t border-border py-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <h2 className="text-3xl font-heading font-medium text-foreground">从灵感到下单</h2>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {["浏览灵感案例", "免费体验基础定制", "解锁 AI / 个性化服务", "确认材质尺寸与价格", "下单打印生产", "配送到家"].map((step, index) => (
              <div key={step} className="rounded-lg border bg-card p-4">
                <p className="text-sm font-heading font-medium text-brand">{String(index + 1).padStart(2, "0")}</p>
        ...
        <section className="border-t border-border pt-14">
          <h2 className="text-3xl font-heading font-medium text-foreground">FAQ</h2>
