...
export function BrandLogo({ centered = false }: BrandLogoProps) {
  return (
    <Link href="/" className={`flex items-center gap-3.5 group ${centered ? "justify-center" : ""}`}>
      <svg width="42" height="24" viewBox="0 0 387 217" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-brand shrink-0">
      ...
      <span className="text-xl text-brand font-semibold font-sans tracking-normal">Finscape</span>
    </Link>
  );
}
