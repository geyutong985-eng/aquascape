...
export const designs: Design[] = [
  ...
  {
    id: "ferris-bubble-daylight",
    title: "晴水粉旋",
    description: "浅蓝背景下的粉色旋涡雕塑和气泡组合，比摩天轮版本更柔软、灵动，适合想要清爽艺术感的桌面鱼缸。",
    coverImage: "/gallery/aquascapes/ferris-bubble-light-tank.png",
    galleryImages: ["/gallery/aquascapes/ferris-bubble-light-tank.png", "/gallery/aquascapes/ferris-bubble-tank.png", "/gallery/aquascapes/moon-bubble-tank.png"],
    author: "Finscape Studio",
    authorType: "official",
    isFeatured: true,
    isPublic: true,
    style: "柔光艺术",
    height: "medium",
    tankSize: { length: 55, width: 32, height: 36 },
    models: [
      { name: "柔粉旋涡塔", tags: ["艺术主景", "柔软线条", "可换色"], price: 168, material: "丝光PLA", color: c("柔粉", "#E8B7B0") },
      { name: "浮动气泡群", tags: ["透明", "点缀", "水感"], price: 78, material: "半透明树脂", color: c("水晶蓝", "#83CFE0") },
    ],
    materials: ["丝光PLA", "半透明树脂"],
    colors: [c("柔粉", "#E8B7B0"), c("水晶蓝", "#83CFE0"), c("浅水蓝", "#9ED5EA")],
    priceMin: 246,
    priceMax: 368,
    viewCount: 1198,
  ...
  {
    id: "moon-bubble-night",
    title: "月泡夜景",
    description: "黑底真实鱼缸质感的月球洞穴和气泡组合，水草更自然，整体比白沙棚拍版更沉静。",
    coverImage: "/gallery/aquascapes/moon-bubble-night-tank.png",
    galleryImages: ["/gallery/aquascapes/moon-bubble-night-tank.png", "/gallery/aquascapes/moon-bubble-tank.png", "/gallery/aquascapes/moon-coral-tank.png"],
    author: "Finscape Studio",
    authorType: "official",
    isFeatured: true,
    isPublic: true,
    ...
    models: [
      { name: "浮动气泡群", tags: ["透明", "夜景", "点缀"], price: 78, material: "半透明树脂", color: c("水晶蓝", "#83CFE0") },
      { name: "月球洞穴", tags: ["洞穴", "夜景", "主景"], price: 128, material: "哑光树脂", color: c("月岩灰", "#8D9298") },
    ],
    materials: ["半透明树脂", "哑光树脂"],
    colors: [c("水晶蓝", "#83CFE0"), c("月岩灰", "#8D9298"), c("墨黑背景", "#111416")],
    priceMin: 206,
    priceMax: 318,
    viewCount: 1126,
    createdAt: "2026-06-19",
