...
export const designs: Design[] = [
  ...
  },
  {
    ...
    title: "晴水摩天轮",
    description: "浅蓝背景下的摩天轮和气泡组合，比黑底版本更明亮清爽，适合想要童趣但不想太暗的桌面鱼缸。",
    ...
    models: [
      { name: "旋转摩天轮", tags: ["主题", "浅色背景", "可换色"], price: 156, material: "丝光PLA", color: c("象牙白", "#F2E3C2") },
      { name: "浮动气泡群", tags: ["透明", "点缀", "水感"], price: 78, material: "半透明树脂", color: c("水晶蓝", "#83CFE0") },
    ],
    materials: ["丝光PLA", "半透明树脂"],
    colors: [c("象牙白", "#F2E3C2"), c("珊瑚橙", "#D86B42"), c("浅水蓝", "#9ED5EA")],
    priceMin: 234,
    priceMax: 356,
    viewCount: 1198,
